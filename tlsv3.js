 ...
 if (process.argv.length < 7){console.log(`node url time rate threads proxyfile`); process.exit();}
 const headers = {};
...
const mozilla = [
 ...
 var pl = platform[Math.floor(Math.floor(Math.random() * platform.length))];
 var mod = mode[Math.floor(Math.floor(Math.random() * mode.length))];
 ...
 var countrys = country[Math.floor(Math.floor(Math.random() * country.length))];
 var dest1 = dest[Math.floor(Math.floor(Math.random() * dest.length))];
 var accept = accept_header[Math.floor(Math.floor(Math.random() * accept_header.length))];
 var bnb = puki[Math.floor(Math.floor(Math.random() * puki.length))];
 ...
 headers["sec-ch-ua-platform"] = randomElement(["Android", "iOS", "Windows"]);
